 ...
 * @author DAVID
 */
public class ReporteConsolidadoFRM extends javax.swing.JFrame {

    /**
     * Creates new form FrameCheckOut
     */
    public ReporteConsolidadoFRM() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("REPORTE CONSOLIDADO");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CODIGO ", "NOMBRE DEL TOUR", "TOTAL CONSUMOS"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReporteConsolidadoFRM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReporteConsolidadoFRM().setVisible(true);
            }
        });
    }
