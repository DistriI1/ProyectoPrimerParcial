...
public class ListaTour extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setBounds(130, 100, 210, 15);
   ...
   //     }catch(IOException e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaTour.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
